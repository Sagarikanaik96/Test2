...
function t(t,a){
	...
	this.content.on("click",".chcb1",function(){
		...
		var allHold = document.querySelectorAll("div[id='hold']");
		if(chcb1.checked==1){
			var allCB = document.querySelectorAll("input[id='chcb2']");
			for(var i=0; i< allCB.length; i++){
				if(jQuery(allHold[i]).attr('name')==0){
